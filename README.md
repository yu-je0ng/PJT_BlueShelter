...
- 서비스 대상 및 기대효과
  - 일반 사용자
    - 개인 정보 노출 없이 의료서비스를 조회하고 기관 관계자와 소통할 수 있음.
    - 정신의료서비스에 대한 접근성을 높이고 심리적 장벽을 낮출 수 있음.
  - 기관 이용자
    - 별도의 관리 없이 플랫폼을 통하여 기관을 홍보하고 일반 사용자와의 소통이 가능함.
    - 잠재 수요자를 중심으로 서비스 니즈 파악이 가능함.
    - 위치 기반의 온라인 상담 서비스를 제공하고 상담이 오프라인까지 연결될 수 있음.
- 수행 도구 
  - 데이터 수집 및 처리 : Python
  - 데이터 적재 : MySQL
